...
<input type='hidden' class='required' name='id' value='' >
...
<table width=100%>
    ...
    <tr>
        <td width=5%>Order</td>
        <td><input class='required' name='order' value='' size=3 maxlength=3></td>
    </tr>
    <tr>
        <td>Subject</td>
        <td><input class='required' name='script_label' value='' size=100></td>
    </tr>
    <tr>
        <td colspan=2>
            <textarea class='required' name='script' rows=20></textarea>
        </td>
    </tr>
</table>
</form>
